/*
 ...
 MODIFIZIERT für Beating Signal's Cover Synthesizer
...
// notes in the melody:
int melody[] = {
  NOTE_C3, NOTE_C3, NOTE_C3, NOTE_AS2, NOTE_C3, 0, 0, NOTE_C3,
  0, NOTE_C3, NOTE_C3, NOTE_AS2, NOTE_C3, 0, 0, NOTE_DS3,
  NOTE_DS3, NOTE_DS3, NOTE_DS3, NOTE_C3, NOTE_C3, 0, NOTE_C3, NOTE_D3,
  0, NOTE_DS3, NOTE_DS3, NOTE_C3, NOTE_C3, 0, 0, 0,
  NOTE_C3, NOTE_C3, NOTE_C3, NOTE_AS2, NOTE_C3, 0, 0, NOTE_AS2,
  0, NOTE_AS2, NOTE_AS2, NOTE_AS2, NOTE_C3, 0, NOTE_C3, NOTE_C3,
  NOTE_DS3, NOTE_DS3, 0, NOTE_DS3, 0, 0, 0, 0,
  NOTE_F3, NOTE_DS3, 0, NOTE_D3, 0, NOTE_DS3, NOTE_DS3, NOTE_DS3, 0, NOTE_C3,
};
...
// the order of the pins from lowest note is 15,16,18,2,4,6,11,12,13,14
  ...
  case B10110: ///////////////////////////////// HIER VMTL Logo
   /* kh=10;   
    ...
    int noteDuration = 220;//1000 / noteDurations[thisNote];
...
void CONTROLS(){ 
  ...
  if (oscswitch==1){
   ...
   glidebutton = digitalRead(1);
    //   glidebutton = 1;
      shiftbutton = digitalRead(15);
      irswitch = digitalRead(14);
      wavepot=(analogRead(5))>>6;
      lfopot= (analogRead(4));
  ...
  if (oscswitch==2){
    ...
    irswitch = 0;
    dswitch=digitalRead(14);
    wavepot=127;
    waveoff=(analogRead(5))+128;
    lfopot = (analogRead(4));
    arppot = 1;
    bpot = (analogRead(3));
       epot = bpot >> 5;
